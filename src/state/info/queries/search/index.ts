...
import { usePoolDatasSWR, useTokenDatasSWR } from 'state/info/hooks'
...
const useFetchSearchResults = (
  ...
  const queryClient = getMultiChainQueryEndPointWithStableSwap("ARB")
  ...
  }, [searchString, searchStringTooShort, tokenQuery, poolQuery, queryClient])
