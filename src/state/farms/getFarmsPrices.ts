...
const getFarmsPrices = (farms: SerializedFarm[], chainId: number) => {
  ...
  const nativePriceUSD = nativeStableFarm?.tokenPriceVsQuote ? new BigNumber(nativeStableFarm?.tokenPriceVsQuote || '0') : BIG_ZERO
...
const nativeStableLpMap = {
  [ChainId.KAI]: {
    address: '0x92fCe3C6A8289F5c57eD813B541FcF18ADFaB458',
    wNative: 'WKEC',
    stable: 'USDT',
  },
  [ChainId.BSC]: {
