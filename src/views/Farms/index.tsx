...
import { Text, Flex, Loading, SearchInput, Select, OptionProps, ButtonMenu, ButtonMenuItem, Button, NextLinkFromReactRouter, OpenNewIcon, Box } from 'components'
...
const Farms = () => {
  ...
  const chosenFarms = useMemo(() => {
    ...
    if (tokenMode) {
      chosenFs = chosenFs.filter((farm) => farm.isTokenOnly)
    } else {
      chosenFs = chosenFs.filter((farm) => !farm.isTokenOnly)
    }
          ...
          <FilterContainer>
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <SearchInput 
                ...
                placeholder={tokenMode ? "Search Pools" : "Search Farms"}
              />
            </LabelWrapper>
          </FilterContainer>
        </ControlContainer>
