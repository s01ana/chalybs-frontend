...
export function VerifyTokenForm({
  ...
  const tokenAddress = safeGetAddress(query.token) ?? ""
    ...
    <Box position="inherit">
      <FormContainer>
        ...
        <Box>
          ...
          <Box>
            <Text fontSize="12px" color="primary">Listing Options</Text>
            <Flex alignItems="center" onClick={() => setListingOption(true)}>
              <Checkbox
                ...
                readOnly
              />
              <Text ml="20px">Auto Listing</Text>
            </Flex>
            <Flex alignItems="center" onClick={() => setListingOption(false)}>
              <Checkbox
                ...
                readOnly
              />
              <Text ml="20px">Manual Listing</Text>
            </Flex>
            {!listingOption && <Text color="text" fontSize="14px">For manual listing, We won't charge tokens for liquidity. You may withdraw {currency?.symbol ?? ""} after the pool ends then do DEX listing yourself.</Text>}
            {listingOption && <Text color="text" fontSize="14px">For auto listing, after you finalize the pool your token will be auto listed on DEX.</Text>}
          </Box>
        </Box>
