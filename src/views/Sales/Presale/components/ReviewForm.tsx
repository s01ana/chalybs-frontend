    ...
    <Box position="inherit">
      <FormContainer>
        ...
        <Box>
          ...
          <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
            <Text color="primary">Presale Rate</Text>
            <Text>{deFiData.presaleRate} {tokenData.tokenSymbol}</Text>
          </Flex>
          <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
            <Text color="primary">Listing Rate</Text>
          ...
          <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
            <Text color="primary">Hard Cap</Text>
            <Text>{deFiData.hardCap} {tokenData.currency.symbol}</Text>
          </Flex>
          <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
            <Text color="primary">Unsold tokens</Text>
            <Text>{deFiData.refundType ? "Refund" : "Burn"}</Text>
          </Flex>
          <Flex width="100%" justifyContent="space-between" px="5px" mb="10px">
            <Text color="primary">Minimum Buy</Text>
