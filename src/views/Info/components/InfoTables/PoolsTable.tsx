import { ArrowBackIcon, ArrowForwardIcon, Box, Flex, NextLinkFromReactRouter, Skeleton, Text } from 'components'
...
const DataRow = ({ poolData, index }: { poolData: PoolData; index: number }) => {
  ...
  return (
    <LinkWrapper to={`/info${chainPath}/pairs/${poolData.address}`}>
      <ResponsiveGrid>
        <Text>{index + 1}</Text>
        <Flex>
          <DoubleCurrencyLogo
